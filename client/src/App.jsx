...
import '/Users/asif/Desktop/QuickGPT/client/src/assets/prism.css'
  ...
  return (
    <>
      ...
      {user ? (
        ...
        <div className='bg-linear-to-b from-[#242124] to-[#00000] flex items-center justify-center h-screen w-screen'>
          <Login />
        </div>
      )}
